...
if (isset($_POST["ajouter"])) {
  $values = array(
    "titre"  => $_POST["titre"],
    "prix"   => $_POST["prix"],
    "debite" => intval($_POST["debite"]),
  );
  $reponse = $depense->addDepense($values);
}
?>
...
<head>
  ...
  <title>Gestion budget Poo-Ajouter une dépense</title>
...
<body>
  ...
  <div class="container">
    ...
    ?>
      <div class="alert alert-<?php echo $reponse["statut"]; ?>" role="alert">
    ...
    <form action=" " method="post">
      ...
      <label for="floatingInput">es-ce que la dépende à été débité ?</label>
      ...
      <div class="form-check">
        <input class="form-check-input" type="radio" name="debite" value="0">
        <label class="form-check-label">
          Non
        </label>
      </div>
