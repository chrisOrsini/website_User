...
$passeword   ="root";
$dbname      ="budget_bdd";
//procédé à la connexion et la stocké dans une variable
...
<form action="" method="POST">
        <div class="form-floating mb-3">
            ...
            <div class="form-floating">
                 <input type="number" class="form-control" id="floatingPassword" placeholder="Ex: 1025" name="prix" value="<?php echo $la_depense['prix'] ?>" required>
                <label for="floatingPassword">Prix de la dépense</label>
            </div>
            
            <input type="hidden" name="id" value="<?php echo $la_depense['id'] ?>">
            <button type="submit" class="btn btn-primary mt-2" name="modifier">Modifier</button>
